 ...
 *
 * @throws ConstructionException If a duplicate or unannotated state is passed in, or no initial
 * state was supplied.
 */
class Controller(states: Array<State>) {
    /** The prelude to any generated DOT graph. */
 ...
 * runtime.
 *
 * @param offender The offending class.
